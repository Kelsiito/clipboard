...
- The current project does not provide cloud sync, per-app ignore rules, pause/retention controls, signing, notarization, or App Store packaging. These remain tracked in the [roadmap](docs/roadmap.md).
