...
- save a text history item to the Library, create and edit a Library item with a collection and tags, filter/search it by metadata, paste it, delete it, and verify it survives history cleanup and restart;
